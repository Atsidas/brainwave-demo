const ButtonSvg = ({ white, color, stationaryColor, isHovered }) => (
  <>
    <svg
    ...
    >
      <path
        ...
        stroke={white ? "white" : isHovered ? stationaryColor : color.stroke}
        strokeWidth="2"
    ...
    >
      {white ? (
        ...
        <>
          <polygon
            fill={isHovered ? stationaryColor : color.fill}
            fillRule="nonzero"
